...
async function invalidateDomain(queryClient: ReturnType<typeof useQueryClient>, domain: "performance" | "accessibility", siteId: string) {
  await Promise.all([
