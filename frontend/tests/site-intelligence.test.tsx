...
function intelligence(): SiteIntelligence {
  return {
    ...
    render: { latest_run: { present: true, id: 4, status: "completed", target_count: 2, created_at: "2026-08-25T02:00:00Z", started_at: null, finished_at: "2026-08-25T02:00:00Z" }, retained_coverage: coverage(8, 10), successful: 7, rate_limited: 0, http_non_success: 0, technical_failure: 1, clock: clock("2026-08-25T02:00:00Z") },
